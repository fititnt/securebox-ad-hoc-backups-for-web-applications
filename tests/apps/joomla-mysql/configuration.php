<?php
/* REFERENCE: https://github.com/joomla/joomla-cms/blob/staging/installation/configuration.php-dist */
class JConfig
{
	/* Site Settings */
	public $offline = '0';
	...
	public $host = 'TEST_SOURCE_MARIADB_HOST_TEST';              // This is normally set to localhost
	public $user = 'TEST_SOURCE_MARIADB_USER_TEST';                       // DB username
	public $password = 'TEST_SOURCE_MARIADB_PASS_TEST';                   // DB password
	public $db = 'TEST_SOURCE_MARIADB_DBNAME_TEST';                         // DB database name
